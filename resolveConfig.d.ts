...
/**
 * Function declaration for resolving a configuration object.
 *
 * @param {T} config - The configuration object to be resolved.
 * @returns {ResolvedConfig<T>} - The resolved configuration object.
 */
